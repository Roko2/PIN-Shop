...
$sQuery="SELECT ID,Naziv,Opis,Jmj,Kvantiteta,JdCijena,NazivPotkategorije,Aktivnost FROM artikl INNER JOIN potkategorije on artikl.IdPotkategorije=potkategorije.IDpotkategorije WHERE artikl.IdPotkategorije=:potkategorija";
